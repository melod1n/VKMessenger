...
class OldConversationAdapter(var fragmentConversations: FragmentConversations, values: ArrayList<VKConversation>) : BaseAdapter<VKConversation, OldConversationAdapter.ViewHolder>(fragmentConversations.requireContext(), values),
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, type: Int): ViewHolder {
        return ViewHolder(view(R.layout.item_conversation, viewGroup))
    }
    ...
    private fun updateConversation(peerId: Int) {
        ...
        set(index, CacheStorage.getConversation(peerId) ?: VKConversation())
    ...
    inner class ViewHolder(v: View) : BaseAdapter.Holder(v) {
        ...
        override fun bind(position: Int) {
            ...
            val avatarSize = AndroidUtils.px(if (isExtended) 60F else 50F)
